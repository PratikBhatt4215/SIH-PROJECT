...
<body>
    ...
    <div class="contact-main">
        <h2><span> Register As Insitution </span> Fill The Below Form !</h2>

        <div class="w-50 m-auto">
            <form action="RWIF.php" method="post">

                <div class="form-group">
                    <label for="pwd">Instuition Name:</label>
                ...
                <div class="form-group">
                    <label for="pwd">Instuition website:</label>
